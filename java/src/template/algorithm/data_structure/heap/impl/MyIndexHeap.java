...
public class MyIndexHeap<T extends Comparable<T>> implements MyHeap<T> {
    ...
    public MyIndexHeap(String mode) {
        this(mode, DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR);
    }

    public MyIndexHeap(String mode, int capacity, float loadFactor) {
        this.mode = mode;
    ...
    public MyIndexHeap(String mode, int capacity) {
        this.mode = mode;
        this.capacity = capacity;
        this.size = 0;
        data = (T[]) new Comparable[capacity + 1]; // start from index 1
    ...
    public static void main(String[] args) {
        ...
        int N = 1000000;
        MyIndexHeap<Integer> indexMaxHeap = new MyIndexHeap<Integer>("max", N);
        for( int i = 0 ; i < N ; i ++ )
